...
// Регион по умолчанию — «Все регионы»: реальных заказов/вакансий по
// Сургуту с площадок почти нет, поэтому без выбора показываем всю
// Россию. Явный выбор города пользователем сохраняется отдельно.
